...
<!--网站主页-->
		...
		<div class="blank055" style="margin-top:20px;"></div>
        <div class="init_title"><p>新手专享</p></div>
...
?>','#deal',2);">
					<div class="novice f_l" style="width: 25px;margin:1.722rem 0px 0 -15px;">
						<?php if ($this->_var['deal']['is_advance'] == 1 && $this->_var['deal']['start_time'] > TIME_UTC): ?>
						<img src="<?php echo $this->_var['TMPL']; ?>/images/novice_0.png" width="110%" height="105%"/>
						<?php elseif ($this->_var['deal']['is_new'] == 1): ?>
						<img src="<?php echo $this->_var['TMPL']; ?>/images/novice.png" width="110%" height="105%"/>
						<?php endif; ?>
					</div>
...
?></span>
                    ...
                    <div style="width:200%;margin-left:-50%;border-top:1px solid #ddd;"></div>
					<div class=" con_height">
						<div class="  w_b  pt tc">
							<div class=" tl lv"><i style=" font-family:Microsoft YaHei; font-size:12px; color:#8a8a8a;">年化收益率</i><br/><i class="big"><?php echo $this->_var['deal']['rate']; ?></i><i class="unit">%</i></div>
							<div class=" tl je" style="margin-left:15px;"><i style="font-family:Microsoft YaHei; font-size:12px; color:#8a8a8a;">融资金额</i><br/><i class="small"><?php 
$k = array (
  'name' => 'replacemoney',
...
?></i><i class="unit">万</i></div>
							<div class=" tl sj" style="margin-left:3px;"><i style="font-family:Microsoft YaHei; font-size:12px; color:#8a8a8a;">投资期限</i><br/><i class="small"><?php echo $this->_var['deal']['repay_time']; ?></i><i class="unit"><?php if ($this->_var['deal']['repay_time_type'] == 1): ?>月<?php else: ?>天<?php endif; ?></i></div>
...
?>
	    ...
	    <?php endif; ?>
	     ...
	     <div class="blank055"></div>		
		<div class="init_title"><p>理财推荐</p></div>
		<div class="blank055"></div>		
		<ul class="recommended_nav_2">
