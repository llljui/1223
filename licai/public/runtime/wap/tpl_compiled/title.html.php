...
?>','#deals')">
	...
	<a class="tab-item" href="#" onclick="RouterURL(window.location.href='http://www.xiaobinqipei.com/mobile/')">
	  <i class="icon iconfont">&#xe633;</i>
	  <span class="tab-label">小滨汽配</span>
	</a>
