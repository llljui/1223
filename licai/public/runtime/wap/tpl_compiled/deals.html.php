...
?>','#deal',2);">
					...
					<div class="novice f_l" >
						...
						<img src="<?php echo $this->_var['TMPL']; ?>/images/novice_0.png" width="130%" height="100%"/>
						<?php elseif ($this->_var['deal']['is_new'] == 1): ?>
						<img src="<?php echo $this->_var['TMPL']; ?>/images/novice.png" width="130%" height="100%"/>
						<?php endif; ?>
					</div>
...
echo $k['name']($k['v']);
?></i><i class="unit" style="color:#757575">万</i></div>
							<div class=" tl sj" style="margin-left:15px;"><i style="font-family:Microsoft YaHei; font-size:12px; color:#8a8a8a;">投资期限</i><br/><i class="small"><?php echo $this->_var['deal']['repay_time']; ?></i><i class="unit"  style="color:#757575"><?php if ($this->_var['deal']['repay_time_type'] == 1): ?>月<?php else: ?>天<?php endif; ?></i></div>
						<div class="w_b_f_1"></div>
						<div  class="progress-radial_parent" style="margin-left:-8px;">
