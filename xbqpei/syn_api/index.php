...
require(dirname(__FILE__) . '/../includes/syn_init.php');
require 'sign.php';
...
//$request = array(
//    'xbqp_user_id' => 45,
//    'password' => 'qianlizeguo55'
//);
//require_once "./lib/edit_pass.action.php";			
//$obj = new edit_pass();
//$obj->index();
//die;
...
$class = strtolower(trim($request['act']));
$act2 = strtolower(trim($request['act_2']))?strtolower(trim($request['act_2'])):"";
...
if(true) 
{
	...
	$GLOBALS['db']->autoExecute("ecs_syn_api_log", $syn_api_log, 'INSERT');
}
