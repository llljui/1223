<?php exit;?>a:3:{s:8:"template";a:3:{i:0;s:85:"F:/XAMPP/htdocs/xbqpei/mobile/themesmobile/68ecshopcom_mobile/car_system_category.dwt";i:1;s:84:"F:/XAMPP/htdocs/xbqpei/mobile/themesmobile/68ecshopcom_mobile/library/goods_list.lbi";i:2;s:84:"F:/XAMPP/htdocs/xbqpei/mobile/themesmobile/68ecshopcom_mobile/library/footer_nav.lbi";}s:7:"expires";i:1497508828;s:8:"maketime";i:1497505228;}<html>
<head>
...
<ul>
<li class="on"><a href="car_system_category.php?car_system_category=868&display=grid&brand=0&price_min=0&price_max=0&filter_attr=0&page=1&sort=goods_id&order=ASC#goods_list">最新</a></li>
<li class=""><a href="car_system_category.php?car_system_category=868&display=grid&brand=0&price_min=0&price_max=0&filter_attr=0&page=1&sort=salenum&order=DESC#goods_list" >销量</a></li>
<li class=""><a href="car_system_category.php?car_system_category=868&display=grid&brand=0&price_min=0&price_max=0&filter_attr=0&page=1&sort=last_update&order=DESC#goods_list" >更新</a></li>
<li class="" ><a href="car_system_category.php?car_system_category=868&display=grid&brand=0&price_min=0&price_max=0&filter_attr=0&page=1&sort=final_price&order=ASC#goods_list">价格<span class="arrow_up "></span><span class="arrow_down "></span></a></li>
<li style=" border-left:1px solid #ccc; margin-right:-1px;"><a href="javascript:;" class="show_type  show_list">&nbsp;</a></li>
</ul>
</section>
<div style=" height:5px"></div>
<script type="text/javascript">
var url = 'car_system_category.php?act=ajax&car_system_category=868&&display=grid&brand=&price_min=&price_max=&filter_attr=&page=1&sort=&order=&other_has=1';
$(function(){
...
<ul><li class="filtrate_list_li"><a href="car_system_category.php?id=757" class="filtrate_list_li_a " style="padding-left:25px"><span>点火系统</span></a><ul>
 
<li class="filtrate_list_li"><a href="car_system_category.php?id=861" class="filtrate_list_li_a " style="padding-left:45px;">分电器</a></li>
 
<li class="filtrate_list_li"><a href="car_system_category.php?id=872" class="filtrate_list_li_a " style="padding-left:45px;">点火开关</a></li>
 
<li class="filtrate_list_li"><a href="car_system_category.php?id=871" class="filtrate_list_li_a " style="padding-left:45px;">火花塞胶套</a></li>
 
<li class="filtrate_list_li"><a href="car_system_category.php?id=870" class="filtrate_list_li_a " style="padding-left:45px;">电容</a></li>
 
<li class="filtrate_list_li"><a href="car_system_category.php?id=869" class="filtrate_list_li_a " style="padding-left:45px;">预热塞</a></li>
 
<li class="filtrate_list_li"><a href="car_system_category.php?id=868" class="filtrate_list_li_a on" style="padding-left:45px;">火花塞</a></li>
 
<li class="filtrate_list_li"><a href="car_system_category.php?id=867" class="filtrate_list_li_a " style="padding-left:45px;">分火线</a></li>
 
<li class="filtrate_list_li"><a href="car_system_category.php?id=866" class="filtrate_list_li_a " style="padding-left:45px;">点火模块</a></li>
 
<li class="filtrate_list_li"><a href="car_system_category.php?id=865" class="filtrate_list_li_a " style="padding-left:45px;">点火锁芯</a></li>
 
<li class="filtrate_list_li"><a href="car_system_category.php?id=864" class="filtrate_list_li_a " style="padding-left:45px;">点火线圈</a></li>
 
<li class="filtrate_list_li"><a href="car_system_category.php?id=863" class="filtrate_list_li_a " style="padding-left:45px;">分火头</a></li>
 
<li class="filtrate_list_li"><a href="car_system_category.php?id=862" class="filtrate_list_li_a " style="padding-left:45px;">分电器盖</a></li>
 
<li class="filtrate_list_li"><a href="car_system_category.php?id=873" class="filtrate_list_li_a " style="padding-left:45px;">插接器</a></li>
...
<li   id="brand_209"><a href="javascript:get_brand('209')">博世/Bosch</a></li>
                </ul>
...
<div class="filtrate_has">
    ...
    <input type="radio" name='other_has' id="all_goods" value="1" checked="true">
    </li>
    <li class="">
