...
elseif ($_REQUEST['act'] == 'add' || $_REQUEST['act'] == 'edit' || $_REQUEST['act'] == 'copy')
{
    ...
    //商家列表
    $merchant_list = $db->table('supplier')->field('supplier_id, supplier_name, company_name')->select();
    $smarty->assign('merchant_list', $merchant_list);
...
elseif ($_REQUEST['act'] == 'insert' || $_REQUEST['act'] == 'update')
{
    ...
    $add_discount = isset($_POST['add_discount']) ? $_POST['add_discount'] : 0;
    ...
    //所属商家
    $supplier_id = intval($_REQUEST['merchant_id']);
    $goods_status = 1;
    if ($supplier_id) {
        //$goods_status = $db->table('supplier')->where('supplier_id = ' . $supplier_id)->getField('status');
    }
    ...
    if ($is_insert)
    {
        if ($code == '')
        {
            $sql = "INSERT INTO " . $ecs->table('goods') . " (goods_name, goods_name_style, goods_sn, " .
                    ...
                    "is_on_sale, is_alone_sale, is_shipping, goods_desc, add_time, last_update, goods_type, rank_integral, suppliers_id, cost_price, year, is_original, output, unit, system_cat_id, dept_ids, supplier_id, original_url, add_discount)" .
                "VALUES ('$_POST[goods_name]', '$goods_name_style', '$goods_sn', '$catgory_id', " .
                    ...
                    " '$_POST[goods_desc]', '" . gmtime() . "', '". gmtime() ."', '$goods_type', '$rank_integral', '$suppliers_id', '$cost_price', '$_POST[year]', '$_POST[is_original]', '$_POST[output]', '$unit', '$system_catgory_id', '$dept_ids', $supplier_id, '$original_url', '$add_discount')";
        }
        else
        {
            $sql = "INSERT INTO " . $ecs->table('goods') . " (goods_name, goods_name_style, goods_sn, " .
                    ...
                    "is_on_sale, is_alone_sale, is_shipping, goods_desc, add_time, last_update, goods_type, extension_code, rank_integral, cost_price, year, is_original, output, unit, system_cat_id, dept_ids, supplier_id, original_url, add_discount)" .
                "VALUES ('$_POST[goods_name]', '$goods_name_style', '$goods_sn', '$catgory_id', " .
                    "'$brand_id', '$shop_price', '$market_price', '$is_promote', '$zhekou', '$promote_price', ".
                    "'$promote_start_date', '$promote_end_date', '$is_buy','$buymax','$buymax_start_date','$buymax_end_date', '$goods_img', '$goods_thumb', '$original_img', ".
                    "'$_POST[keywords]', '$_POST[goods_brief]', '$_POST[seller_note]', '$goods_weight', '$goods_number',".
                    " '$warn_number', '$_POST[integral]', '$give_integral', '$is_best', '$is_new', '$is_hot', 0, '$is_on_sale', '$is_alone_sale', $is_shipping, ".
                    " '$_POST[goods_desc]', '" . gmtime() . "', '". gmtime() ."', '$goods_type', '$code', '$rank_integral', '$cost_price', '$_POST[year]', '$is_original', '$output', '$unit', '$system_catgory_id', '$dept_ids', $supplier_id, '$original_url', '$add_discount')";
        }
    }
    else
    {
